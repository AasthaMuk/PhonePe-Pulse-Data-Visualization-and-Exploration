        ...
        if Type == "Transactions":
            ...
            with col2:
                ...
                cursor.execute("""
                    ...
                    where year = %s and quarter = %s 
                    group by district order by Total desc limit 10""",(Year,Quarter))
            ...
            with col3:
                ...
                cursor.execute("""
                    ...
                    where year = %s and quarter = %s 
                    group by pincode order by Total desc limit 10""",(Year,Quarter))
        ...
        if Type == "Users":
            ...
            with col1:
                ...
                if Year == 2023 and Quarter == 4:
                    st.toast('🔥 No Data for Quarter 4 for year 2023 !!!')
                else:
                    cursor.execute("""
...
def menu_view_map(selected):
    ...
    if selected == "View Map":
        ...
        if Type == "Transactions":
            ...
            df1.State = df2
            set_geo_map(df1,'Total_Transactions')
        ...
        if Type == "Users":
            ...
            df1.State = df2
            set_geo_map(df1,'Total_Appopens')
...
def set_sidebar():
    ...
    st.sidebar.title(":wave: :violet[**Hi Aastha !!! Welcome to the dashboard**]")
    with st.sidebar:
        selected = option_menu("Menu", ["Home","Top Charts","View Map","About"], 
...
def set_geo_map(df1,color):
        ...
        with st.container() as map_container:
            st.plotly_chart(fig,use_container_width=True)
